...
h2. An easy way to intall elasticsearch on fedora/rhel based systems.
...
everything from source and using any other prevously package libraries.
There were some glaring omissions from the package tree in order to use this
one. 

h2. I have not run these packages on a production sytem yet, so use at your
own risk. 
